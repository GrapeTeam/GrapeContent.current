...
public class CrawlerDataReceiverTGQ {
	...
	public String publishTZGG(){
		...
		return CrawlerDataReceiver.publish(receiveJSON, "59895f44c6c20418046dc112", "59227dda1a4769cbf5983cd5");
	}
	...
	public String publishGZDT(){
		...
		return CrawlerDataReceiver.publish(receiveJSON, "5989326cc6c20418046dc110", "59227dda1a4769cbf5983cd5");
	}
	...
	public String publishZCFG(){
		JSONObject post = (JSONObject) execRequest.getChannelValue(grapeHttpUnit.formdata);
		JSONObject receiveJSON = CrawlerDataReceiver.parseCrawlerData(post);
		return CrawlerDataReceiver.publish(receiveJSON, "59895f88c6c20418046dc113", "59227dda1a4769cbf5983cd5");
	}
	...
	public String publishJDBG(){
		JSONObject post = (JSONObject) execRequest.getChannelValue(grapeHttpUnit.formdata);
		JSONObject receiveJSON = CrawlerDataReceiver.parseCrawlerData(post);
		return CrawlerDataReceiver.publish(receiveJSON, "59895fa6c6c20418046dc114", "59227dda1a4769cbf5983cd5");
	}
	...
	public String publishSYTPXW(){
		JSONObject post = (JSONObject) execRequest.getChannelValue(grapeHttpUnit.formdata);
		JSONObject receiveJSON = CrawlerDataReceiver.parseCrawlerData(post);
		return CrawlerDataReceiver.publish(receiveJSON, "59899655c6c2041220867141", "59227dda1a4769cbf5983cd5");
	}
}
